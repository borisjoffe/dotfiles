...
cp -u -R ~/.{*aliases,shellrc,bashrc,screenrc,vimrc,zsh*,*.zsh,tmux*.conf,xbindkeysrc,Xresources*,xinitrc,tidyrc,editorconfig,jshintrc,eslintrc,gitconfig,gitignore.global,ackrc,npm_lazy.config.js,npmrc,mongorc.js,env,tmuxp,noderc.js,gtkrc-2.0*} .
cd $HOME
